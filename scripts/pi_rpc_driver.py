...
def main() -> int:
    ...
    if goal_text:
        ...
        kickoff_message = (
            ...
            "smell.\n"
            "- Optimize something with measurable user impact: lint/type "
            "errors a maintainer cares about, test runtime, dead code, "
            "complexity hotspots, doc gaps that have a count, …\n"
